...
> Comreb是一位全栈开发者的个人技术博客，分享全栈开发的经验和技巧。这里有最新的前沿技术和最佳实践，帮助你成为一名优秀的全栈开发者。
...
```yml
title: Comreb
subtitle: 深度探索科技前沿，分享最新的技术资讯和教程
description: Comreb是一位全栈开发者的个人技术博客，分享全栈开发的经验和技巧。这里有最新的前沿技术和最佳实践，帮助你成为一名优秀的全栈开发者。
keywords:
# 作者名称，会显示在侧边栏
author: comreb
```
...
```yml
card_author:
  description: 深度探索科技前沿，分享最新的技术资讯和教程
```
...
```sh
# 克隆仓库
$ git clone https://github.com/zizhuspot/www.comreb.com.git
# 安装依赖
$ yarn install
# 运行
$ yarn server
